...
export const Url = {
    ...
    WompiBaseUrlSandbox: 'https://sandbox.wompi.co/v1',
    MegarastreoUrl: 'https://api.v2.megarastreo.co',
    MegarastreoBase: "s1.megarastreo.co",// ,
    MegarastreoPort: 8443,
    MegarastreoNamespace: "/position",
